            ...
            <div>
              ...
              <q-card-section class="q-pa-sm">
                <q-list class="row justify-center">
                  ...
                  <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <q-item-section>
                      <q-input dense v-model="course" label="Curso" />
                    </q-item-section>
                  </q-item>
                  <q-item
                    class="col-12"
                      ...
                      >
                        <label class="file-label">
                          ...
                          <span class="file-cta">
                            ...
                            <span class="file-label"> Selecione a foto… </span>
                          </span>
              ...
              <q-card-actions full-width>
                ...
                >
                  ...
                  />
                  <q-btn
                    class="text-capitalize bg-primary text-white q-ma-md"
                    @click="generate()"
                    style="width: 120px"
                    :label="'ENVIAR'"
                  />
...
export default defineComponent({
  ...
  methods: {
    ...
    confirmClear() {
      confirmDialog("Atenção", "Deseja realmente apagar?", this.clear);
    },
    clear() {
      this.name = "";
      this.address = "";
